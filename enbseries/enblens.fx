...
// SonicEther: Original author of Bloom code           //
...
#define post_mixer_bloomShape 1.4
#define ECCInWhite 0.85
#define	ECCOutBlack 0.0

// DAY
#define ECCInBlackDay 		0.0f
#define ECCOutWhiteDay 		1.0f
// NIGHT
#define ECCInBlackNight		0.0f
#define ECCOutWhiteNight	1.1
// INTERIOR
#define ECCInBlackInterior	0.0f
#define ECCOutWhiteInterior	1.05

#define fBloomFNearDepth 50.0

//#define fSaturation	(1.0,1.0,1.0,0.75)
...
float4  PS_GaussHResizeFirst(VS_OUTPUT_POST IN, float4 v0 : SV_Position0,
  uniform Texture2D inputtex, uniform float texsize, uniform float Iteration, uniform float fBloomIntensityIn, uniform float fContrastIntensityIn) : SV_Target
{
  float4  res;

  float fContrast= (1.12f+fContrastIntensityIn);
  ...
  res.xyz/=2;
  	...
  	res.xyz=max(res.xyz-((ECCInBlack*fBloomIntensityIn)*0.1), 0.0) / max(ECCInWhite-(ECCInBlack*0.1), 0.00001);
	if (fContrast!=1.0) res.xyz=pow(res.xyz, fContrast);
	res.xyz=res.xyz*((ECCOutWhite*fBloomIntensityIn)-ECCOutBlack) + ECCOutBlack;
...
technique11 SubtlePassMBloom <string UIName="THE ENHANCER";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
    SetPixelShader(CompileShader(ps_5_0, PS_GaussHResizeFirst(TextureDownsampled, 1536.0, 2, 0.85, 0.0f)));
  }
}
technique11 SubtlePassMBloom1 <string RenderTarget="RenderTarget1024";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
    SetPixelShader(CompileShader(ps_5_0, PS_GaussVResizeFirst(TextureColor, 1536.0, 2, 0.85, 0.0f)));
  }
}
technique11 SubtlePassMBloom2
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
    SetPixelShader(CompileShader(ps_5_0, PS_GaussHResizeFirst(RenderTarget1024, 512.0, 4, 0.85, 0.0f)));
  }
}
technique11 SubtlePassMBloom3 <string RenderTarget="RenderTarget512";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
    SetPixelShader(CompileShader(ps_5_0, PS_GaussVResizeFirst(TextureColor, 512.0, 4, 0.85, 0.0f)));
  }
}
technique11 SubtlePassMBloom4
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom5 <string RenderTarget="RenderTarget256";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom7 <string RenderTarget="RenderTarget128";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom9 <string RenderTarget="RenderTarget64";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom10 
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom11 <string RenderTarget="RenderTarget32";>
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 SubtlePassMBloom12
{
  pass p0
  {
    SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
