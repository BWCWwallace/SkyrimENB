...
float4	PS_Adaptation(VS_OUTPUT_POST IN, float4 v0 : SV_Position0) : SV_Target
{
	...
	valcut=min(valcut, lerp(lerp(AdaptationParameters.y*0.33, AdaptationParameters.y, ENightDayFactor), AdaptationParameters.y*0.5, EInteriorFactor)); //AdaptationMax
...
technique11 Draw <string UIName="THE ENHANCER";>
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad(0.0, 0.0)));
